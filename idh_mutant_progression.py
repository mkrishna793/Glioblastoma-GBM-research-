...
g2_patients = df_idh_clin[df_idh_clin['Grade_2021'] == 'G2'].index.tolist()
g4_patients = df_idh_clin[df_idh_clin['Grade_2021'] == 'G4'].index.tolist()

g2_patients = [p for p in g2_patients if p in df_rna.columns]
g4_patients = [p for p in g4_patients if p in df_rna.columns]

treated_patients = df_idh_clin[df_idh_clin['Chemo_status (TMZ treated=1;un-treated=0)'] == 1].index.tolist()
untreated_patients = df_idh_clin[df_idh_clin['Chemo_status (TMZ treated=1;un-treated=0)'] == 0].index.tolist()
...
for clust in clusters:
    clust_patients = df_idh_clin[df_idh_clin['Protein_Cluster'] == clust].index.tolist()
